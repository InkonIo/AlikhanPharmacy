...
public class Grippheron extends JFrame {
    ...
    public Grippheron(String userEmail, ArrayList<String> selectedMedicines) {
        ...
        double price = MedicineDatabase.getPrice("Грипферон");
        ...
        JLabel nameLabel = new JLabel("Грипферон - " + price + " тг.");
        nameLabel.setFont(new Font("Arial", Font.BOLD, 18));

        JLabel descLabel = new JLabel("<html>Грипферон обладает противовирусным и иммуномодулирующим действием.<br>Применяется для профилактики и лечения гриппа и ОРВИ.</html>");
    ...
    private void addToBasket() {
        if (count > 0) {
            for (int i = 0; i < count; i++) {
                selectedMedicines.add("Грипферон");
            }
        }
    }
