...
public class VitaminsWindow extends JFrame {
    ...
    public VitaminsWindow(String userEmail, ArrayList<String> selectedMedicines) {
        ...
        addMedicineButton("Аскорбинка", "Витамин C, укрепляет иммунитет.", "exam/src/main/resources/Images/Vit/askorbin.jpg", AscorbinWindow.class);
        addMedicineButton("Тиамин", "Витамин B1, необходим для нервной системы.", "exam/src/main/resources/Images/Vit/tiamin.png", ThiaminWindow.class);
        addMedicineButton("Ретинол", "Витамин A, полезен для зрения.", "exam/src/main/resources/Images/Vit/retinol.jpeg", RetinolWindow.class);
