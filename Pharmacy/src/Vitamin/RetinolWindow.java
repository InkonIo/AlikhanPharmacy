...
public class RetinolWindow extends JFrame {
    private String userEmail;
    private ArrayList<String> selectedMedicines;
    private int count = 0;
    private JLabel countLabel;

    public RetinolWindow(String userEmail, ArrayList<String> selectedMedicines) {
        ...
        double price = MedicineDatabase.getPrice("Ретинол");

        JPanel panel = new JPanel(new BorderLayout());
        panel.setBackground(new Color(200, 230, 229));
        panel.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));

        ImageIcon icon = new ImageIcon("exam/src/main/resources/Images/Vit/retinol.jpeg");
        ...
        JLabel nameLabel = new JLabel("Ретинол - " + price + " тг.");
        nameLabel.setFont(new Font("Arial", Font.BOLD, 18));

        JLabel descLabel = new JLabel("<html>Витамин A, полезен для зрения и кожи.</html>");
        ...
        backButton.addActionListener(e -> {
            dispose();
            new Vitamin.VitaminsWindow(userEmail, selectedMedicines);
        });
