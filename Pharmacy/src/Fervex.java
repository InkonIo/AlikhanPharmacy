...
public class Fervex extends JFrame {
    ...
    public Fervex(String userEmail, ArrayList<String> selectedMedicines) {
        ...
        double price = MedicineDatabase.getPrice("Фервекс");

        JPanel panel = new JPanel(new BorderLayout());
        panel.setBackground(new Color(200, 230, 229));
        panel.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));

        ImageIcon icon = new ImageIcon("exam/src/main/resources/Images/Prostuda/fervex.jpg");
        ...
        JLabel nameLabel = new JLabel("Фервекс - " + price + " тг.");
        nameLabel.setFont(new Font("Arial", Font.BOLD, 18));

        JLabel descLabel = new JLabel("<html>Фервекс помогает при симптомах простуды и гриппа:<br>снижает температуру, устраняет насморк, облегчает общее состояние.</html>");
